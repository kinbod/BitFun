...
| 最小事件注册表 | `project.opened`、`task.started`、`policy.decided`、`security.decided`、`verification.completed`、`task.completed`、`stage.outcome.evaluated`、`quality.consistency.sampled` | 快速路径、安全提示、任务摘要、阶段收益和质量一致性可追踪 |
